...
- あらゆるゲームの キャラ／障害物／アイテム etc. は、すべて**データ**の集まりです。
- ゲーム画面に動きがあるということは、**データが変化している**ことに他なりません。

よって、次のことがわかれば、ゲームプログラムの構成要素が分かったことになります。
...
以上が今回の主役となります。  
まずはこれらに関係するデータについて考え、その他についてはコードを書きながらおいおい考えていくことにします。
...
と考えておきます。これらのデータはエンティティごとに管理しなくてよいことになります。
